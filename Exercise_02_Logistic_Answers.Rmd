...
The larger r values cause the function to reach it's approximate carrying capacity faster, but also result in more fluctuations around the carrying capacity as the population exceeds the carrying capacity, falls, and then grows again.

```{r}

plotLogistic <- function(r){
  K = 10        ## carrying capacity      
  n0 = .1       ## initial population size
  ...
  plot(time,n,ylim=c(0,12),lwd=3,type='l',
     bty='l',cex.lab=1.5,
     xlab="Time",ylab="Population Size",main=r)
  #lines(time,n,col="cyan")
}
plotLogistic(r=1.95)
plotLogistic(r=1)
plotLogistic(r=2.05)
...
```{r}
qnorm(c(0.025,0.975),0,1)		    # what width CI is specified by these values? <- 95% CI
...
```{r}
x = seq(0,5,by=0.1)
plot(x,dexp(x),type='l',main="Probability Density Function")
plot(x,pexp(x),type='l',main="Cumulative Distribution Function")
p = seq(0,1,by=0.01)
plot(p,qexp(p),type='l',main="Quantile Function")
hist(rexp(10000),main="Samples")
...
abline(v=quantile(x,c(0.025,0.5,0.975)),lty=c(2,1,2),lwd=3,col="orange")
abline(v=mean(x),col="red",lwd=3,lty=3)
print(paste("Original Mean:",mean(x)))
print(paste("Original Medium:",quantile(x,c(0.5))))
print(quantile(x,c(0.025,0.975)))


hist(y,main="Transformed distribution",breaks=40)
abline(v=quantile(y,c(0.025,0.5,0.975)),lty=c(2,1,2),lwd=3,col="orange")
abline(v=mean(y),col="red",lwd=3,lty=3)
print(paste("Transformed Mean:",mean(y)))
print(paste("Transformed Medium:",quantile(y,c(0.5))))
print(quantile(y,c(0.025,0.975)))
```
...
```{r}
plot(seq(1,NT),n[1,],lwd=3,type='l',bty='l',cex.lab=1.5,xlab="Time",ylab="Population",ylim=c(0,12))
for(i in 2:10){
  lines(seq(1,NT),n[i,],lwd=3,type="l",col=i)
}
...
plot(seq(1,NT),n[1,],lwd=3,type='l',bty='l',cex.lab=1.5,xlab="Time",ylab="Population",ylim=c(0,14))

ciEnvelope(x=seq(1,NT),n.stats[1,],n.stats[3,],col="lightblue")
for(i in 1:10){
  lines(seq(1,NT),n[i,],lwd=3,type="l",col=i)
}
```
...
```{r}
n.stats = apply(n,2,quantile,c(0.025,0.5,0.975))
plot(seq(1,NT),n.stats[2,],lwd=3,type='l',bty='l',cex.lab=1.5,xlab="Time",ylab="Population",ylim=c(0,14))
ciEnvelope(x=seq(1,NT),n.stats[1,],n.stats[3,],col="lightblue")
lines(seq(1,NT),n.stats[2,],lwd=3,type='l')
...
plotLogIC <- function(r){
  ...
  n.stats = apply(n,2,quantile,c(0.025,0.5,0.975))
  plot(seq(1,NT),n.stats[2,],lwd=3,type='l',bty='l',cex.lab=1.5,xlab="Time",ylab="Population",ylim=c(0,14),main=paste("r=",r))
  ciEnvelope(x=seq(1,NT),n.stats[1,],n.stats[3,],col="lightblue")
  lines(seq(1,NT),n.stats[2,],lwd=3,type='l')
}
